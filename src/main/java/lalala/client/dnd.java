...
import lalala.client.demo.DemoDragHandler;
import lalala.client.demo.DualListExample;
...
public class dnd implements EntryPoint {
  ...
  public void onModuleLoad() {
      ...
      boundaryPanel.addStyleName("demo-DualListExample");
      boundaryPanel.setPixelSize(900,600);

      mainPanel.add(new HTML(
              "<div style='font-weight: bold; font-size: 1.2em;'>" + " Rooms View </div>"));
      ...
      final DemoDragHandler demoDragHandler = new DemoDragHandler(null);
      dragController.addDragHandler(demoDragHandler);

      boundaryPanel.add(new DualListExample(demoDragHandler));
...
//    //RootPanel.get("roomViewContainer").add(verticalPanel);
//
